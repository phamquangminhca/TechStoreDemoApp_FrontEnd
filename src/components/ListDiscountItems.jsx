  ...
  return (
    <div className='list-discount-items'>
        <div className='list-discount-items__top'>
            ...
            <span style={{"marginLeft":"690px"}}>Ends in</span>
        ...
        <div className='list-discount-items__bottom'>
            <DiscountItem img={discountItem1} productName='Apple Watch Series 7 Aluminium Cellular' price='20.490.000VND' numItemsSold='231' goodRating={true}/>
